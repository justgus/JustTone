# JustTone Architecture

## Dependency boundaries

- `JustToneCore` is platform-neutral and owns deterministic pitch and tuning-domain models. It must not import SwiftUI, AVFoundation, WatchConnectivity, or persistence frameworks.
- The iPhone and Watch presentation targets own SwiftUI state and views. They depend on `JustToneCore`; the core never depends on either application.
